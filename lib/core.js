...
const { SkillID, Vec3 } = require('tera-data-parser/types'),
	...
	skillPolishing = require('../config/polishing'),
...
module.exports = function SPCore(mod) {
	const skillsClient = require('../config/skills_client')
...
(Server bug: Having Noctenium Infusion in inventory causes skill delays)`)
		...
		// Cannot cast skills while dead or silenced - TODO: Properly support category silence abnormals
