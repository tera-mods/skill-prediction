...
module.exports = {
	0: { // Warrior
		...
		// Awakening
		40: true, // Blade Waltz
		41: true, // Aerial Scythe (DISABLING REQUIRES EDITTING '/config/abnormalities.js')
	...
	2: { // Slayer
		...
		27: true, // Savage Strike (DISABLING REQUIRES EDITTING '/config/abnormalities.js')
		28: true, // Unsheathe
	},
	3: { // Berserker
		"enabled": true,
	...
	8: { // Reaper
		"enabled": true,
		1: true, // Spiral Barrage (DISABLING REQUIRES EDITTING '/config/abnormalities.js')
		3: true, // Double Shear
	...
	9: { // Gunner
		"enabled": true,
		1: true, // Blast (DISABLING REQUIRES EDITTING '/config/abnormalities.js')
		2: true, // Bombardment
		3: true, // Scattershot
		4: true, // Point Blank
		5: true, // Burst Fire
		6: true, // Time Bomb (DISABLING REQUIRES EDITTING '/config/abnormalities.js')
		...
		19: true, // ST
		20: true, // Retaliate
		40: true, // Rolling Reload (DISABLING REQUIRES EDITTING '/config/abnormalities.js')
		// Awakening
	...
	11: { // Ninja
		"enabled": true,
		1: true, // Combo Attack (DISABLING REQUIRES EDITTING '/config/abnormalities.js')
		2: true, // Shadow Jump
	...
	12: { // Valkyrie
		"enabled": true,
		1: true, // Slash (DISABLING REQUIRES EDITTING '/config/abnormalities.js')
		2: true, // Overhead Slash
		3: true, // Glaive Strike
		4: true, // Charge
		5: true, // Maelstrom
		6: true, // Leaping Strike
		7: true, // Spinning Death (DISABLING REQUIRES EDITTING '/config/abnormalities.js')
		8: true, // Titansbane
		9: true, // Ground Bash
		10: true, // Dream Slash
